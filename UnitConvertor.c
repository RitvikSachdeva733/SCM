...
int main() {
  ...
  // F for Fahreinheit;
  // C for Celsius; 
  int tempChoice,currencyChoice,massChoice,userinputF,userinputC,userinputUSDtoEuro,userinputUSDtoJPY,userinputUSDtoRMB,userinputOunce,userinputGram,fahrenheitToCelcius,celciusToFahrenheit;
